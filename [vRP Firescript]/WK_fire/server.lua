...
AddEventHandler('fire:chatAlert', function( text )  
    --TriggerClientEvent('meleeInProgress', -1, 'FIRE', {255, 0, 0}, 'Der er opdaget en brand ved: ' .. text) -- vrp_firenotify
	-- tag det af hvis du vil brug det i chat og det anden ud -- take it off if you want to use it in chat and the other one out
	--TriggerClientEvent('chatMessage', -1, 'FIRE', {255, 0, 0}, 'Der er opdaget en brand ved: ' .. text) -- chatMessage
end)
